 ...
 */
package atg.tools.dynunit.server.http;

import atg.server.http.HttpConnectionServletInputStream;
...
public class TestingHttpConnectionServletInputStream
        extends HttpConnectionServletInputStream {
   ...
   */
     ...
     *
     * @param pIn            the InputStream this will use to read its input
     * @param pContentLength The "content length" size typically sent by an HttpClient
     */
    public TestingHttpConnectionServletInputStream(InputStream pIn, int pContentLength) {
        super(pIn);
        setRequestContentLength(pContentLength);
        // FIXME: more package-local access
