 ...
 */
public class MockDynamoHttpServletRequest
        extends DynamoHttpServletRequest {

    private final Map<String, String> cookieParameters = new HashMap<String, String>(), headers = new HashMap<String, String>();

    private final Map<String, Object> parameters = new HashMap<String, Object>(), components = new HashMap<String, Object>(), attributes = new HashMap<String, Object>();

    private final List<String> serviceParameters = new ArrayList<String>(), servicedLocalParameter = new ArrayList<String>();
    ...
    @Override
    public boolean serviceLocalParameter(String name,
    ...
    @Override
    public boolean serviceParameter(String name, ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
