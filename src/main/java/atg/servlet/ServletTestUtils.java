...
public class ServletTestUtils {
     ...
     *
     * @param pNucleus    the nucleus to use.
     * @param pParameters A set of request parameters that this request should
     *                    initially be populated with. Values can be simple Strings, or
     *                    can beString[] or List<String> objects for multi-value
     *                    parameters.
     * @param pBufferSize The size in bytes of the backing buffer holding stream data for
     *                    this request
