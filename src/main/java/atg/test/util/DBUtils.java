...
public class DBUtils {
    ...
    public DBUtils(Properties pProps)
        ...
        this(
                ...
                pProps.getProperty("driver"),
                pProps.getProperty("user"),
                pProps.getProperty("password")
        );
    }
    ...
    // ---------------------------
    public DBUtils(String pURL, String pJDBCDriver, String pUser, String pPassword)
            throws Exception {
    ...
    public File createFakeXADataSource(File pRoot)
            throws IOException {
        return GSATestUtils.createFakeXADataSource(pRoot, mJDBCProperties, null);
    }

    public File createFakeXADataSource(File pRoot, String pName)
            throws IOException {
